...
<body>
    ...
    echo '<img src="img/3ame.jpg" class="card-img-top" alt="...">';
    echo '<div class="card-body">';
    echo '<h5 class="card-title">'. $_SESSION['product'][$i]['title']  .'</h5>';
    echo '<p class="card-text">'.$_SESSION['product'][$i]['description'] .'</p>';
    echo ' <div class="btn btn-primary">'.$_SESSION['product'][$i]['price'].' JD</div>';
    echo '</div>';
    echo '</div>';
    }
    echo '</div>';
